    ...
    <template x-if="$wire.preview==false">
        <div>
            ...
            <nav aria-label="Breadcrumb" class="my-2">
                <ol class="flex items-center mb-2 gap-1 text-sm text-gray-600 dark:text-gray-300">
                    <li>
                        <a href="#" class="block transition hover:text-gray-700 dark:hover:text-gray-200">
                            <span class="sr-only"> Home </span>
                    ...
                    <li>
                        <select wire:model.live="idDashboardTerpilih"
                            class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            <option value="0">Pilih Wilayah</option>
                            @if ($kelurahanDashboard)
                                @foreach ($kelurahanDashboard as $item)
                                    <option value="{{ $item['idKawasan'] }}">
                                        {{ $item['kawasan'] }}</option>
                                @endforeach
                            @endif
                        </select>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                <table
                    ...
                    <thead class="ltr:text-left rtl:text-right">
                        <tr>
                            <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">Kelurahan
                            </th>
